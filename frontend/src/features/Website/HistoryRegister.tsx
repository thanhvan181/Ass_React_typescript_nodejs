  ...
  return (
      ...
      <div className="card1 mt-50 mb-50">
        ...
        <div className="gap">
          ...
          <div className="title mx-auto"> Lich su dang ky tiem </div>
        </div>
     
       
        <div className="main"> 
        <div className="row row-main">
        <h2 className='text-h5'>Thong tin Vaccine da dang ky</h2>
          ...
          <hr />
          {
              resgisterdetails && resgisterdetails.map((item:any) => {
                  ...
                  return (
                    ...
                    <div className="row">
                      <div className="col"> <b> Ngay Sinh</b> </div>
                    ...
                    <div className="row">
                      <div className="col"> <b>Ten Nguoi Than Lien He</b> </div>
