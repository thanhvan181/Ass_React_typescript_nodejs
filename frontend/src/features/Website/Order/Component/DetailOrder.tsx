    ...
    <>
      ...
      <div className="card1 mt-50 mb-50">
        ...
        <div className="main"> <span id="sub-title">
          <h5 className='text-h5'>Danh sach vac sin</h5>
        </span>
          ...
          <hr />
          <div className="total">
            <h2 className='text-h5'>Thong tin Order</h2>
            <div className="row">
              <div className="col"> <b>Ten:</b> </div>
